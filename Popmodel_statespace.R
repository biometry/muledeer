...
par(mfrow=c(2,2))
parinfo <- data.frame("0-1" = numeric(4), "0-2" = numeric(4), "0-3" = numeric(4), "0-4" = numeric(4), row.names=c("mean of rmax", "mean of K", "mean of sigma2.obs", "mean of sigma2.proc"))
...
inits <- function(){list(sigma.proc = 1, mean.rmax = 2, K = 2, sigma.obs = 1, N.est = c(1, rep(NA, (tsteps-1))))}
